...
# LOCALIZATION_ODOM_TOPIC = "/bluerov2/mavros/global_position/local"
...
SONAR_FEATURE_THRESH_IMG_TOPIC = SLAM_NS + "feature_extraction/feature_img_thresh"
