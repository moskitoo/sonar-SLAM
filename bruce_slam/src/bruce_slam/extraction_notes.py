...
class FeatureExtraction(object):
    ...
    def init_node(self, ns="~"):
        ...
        if self.compressed_images:
            ...
            # SONAR MESSAGE REPLACED WITH PREPROCESSED SONAR IMAGE
            self.sonar_sub = rospy.Subscriber(
    ...
    def callback(self, sonar_msg):
        ...
        #the image is not compressed, just use the ros numpy package
            ...
            # COLOR PREPROCESSED SCAN IMAGE CONVERTED TO GRAYSCALE
        ...
        # SONAR SCAN REPLACED BY PREPROESSED SONAR IMAGE
        ...
        # IMAGE SCAN DOESNT TO BE CONVERTED TO CARTESIAN SINCE PREPROCESSED ONE IS ALREADY IN CARTESIAN   
        locs = np.c_[np.nonzero(peaks)]


        # HERE IS THE ISSUE. HOW TO CONVERT DETECTIONS FROM IMAGE COORDS TO METERS SO THAT POINT CLOUD IS CORRECT
